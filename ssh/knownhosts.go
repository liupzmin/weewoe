...
// Package ssh implements a parser for the OpenSSH known_hosts
...
// IsHostAuthority can be used as a hostCallback in ssh.CertChecker
...
// IsRevoked can be used as a hostCallback in ssh.CertChecker
...
// New creates a host key hostCallback from the given OpenSSH host key
// files. The returned hostCallback is for use in
...
func New(files ...string) (ssh.HostKeyCallback, *hostKeyDB, error) {
	...
	return certChecker.CheckHostKey, db, nil
}
